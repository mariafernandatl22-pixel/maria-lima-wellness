      ...
      <div className="container mx-auto px-6 py-20 relative z-10">
        <div className="max-w-4xl mx-auto text-center space-y-8 animate-fade-in">
          ...
          <p className="text-xl md:text-2xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            Por <span className="font-semibold text-foreground">Maria Fernanda T Lima</span> — 
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-8">
            ...
            <Button 
              size="lg" 
              variant="outline"
              className="border-2 border-eucalyptus text-foreground font-semibold px-8 py-6 rounded-full hover:bg-eucalyptus/10 transition-all hover:scale-105"
            >
